    ...
    public partial class StudentDataEntry : Form
    {
        ...
        private void save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                InsertStudentData();
                MessageBox.Show("Data saved successfully for Student.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
        ...
        private void InsertStudentData()
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("InsertStudent", connection))
                {
                    ...
                    command.Parameters.AddWithValue("@StudentNumber", StudentNumberTB.Text);
